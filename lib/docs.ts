...
const NAVIGATION_GROUPS: { title: string; pageIds: string[] }[] = [
  {
    title: "Start here",
    pageIds: ["introduction", "how-to-play", "money-flows", "faq", "glossary"],
  },
  {
    title: "Game",
    pageIds: ["rounds-and-grabs", "holder-emissions", "winner-settlement"],
  },
  {
    title: "Recovery",
    pageIds: ["recovery-overview", "commitments-and-claims", "future-sponsorship"],
  },
  {
    title: "POTATO",
    pageIds: ["potato-token", "treasury-rewards"],
  },
  {
    title: "Market",
    pageIds: ["canonical-pool", "launch-curves", "buybacks"],
  },
  {
    title: "Operators",
    pageIds: ["operators-overview", "register-and-claim"],
  },
  {
    title: "Protocol",
    pageIds: ["architecture", "configuration", "governance", "security-model"],
  },
  {
    title: "Build",
    pageIds: ["integration", "indexing", "events-and-errors"],
  },
  {
    title: "Reference",
